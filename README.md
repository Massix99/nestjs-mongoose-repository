...
### Simple Approach (Service extends Repository)

For simple use cases, you can extend the base repository directly in your service:
...
### Full Approach (Separate Repository)

For larger applications, use a separate repository class for better separation of concerns:
